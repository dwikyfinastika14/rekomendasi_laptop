...
@section('container')
    <div><a class="btn btn-link" role="button" id="menu-toggle-L" href="#menu-toggle-L"><i
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h5 class="text-black-50 float-left judul-header">List Admin</h5><a
                        class="btn btn-sm float-right smsp-button" role="button" href="setup_kacamata.html"><i
                            class="fa fa-pencil-square-o"></i>&nbsp; List</a>
                </div>
            </div>
                            ...
                            <table class="table table-striped table-hover table-bordered table-sm">
                                <thead>
                                    <tr class="table-secondary text-center text-black-50">
                                        ...
                                        <th class="border rounded-0 border-secondary judul-header">Nama Admin</th>
                                        <th class="border rounded-0 border-secondary judul-header">Email Admin</th>
                                ...
                                <tbody class="text-body">
                                    <tr>
                                        ...
                                        <td class="text-center"><a class="smsp-icon-edit" href="#"><i
                                                    class="fa fa-pencil-square-o"></i></a><a class="smsp-icon-delete"
